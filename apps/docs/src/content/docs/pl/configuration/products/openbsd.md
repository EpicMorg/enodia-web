---
title: OpenBSD
description: Konfiguracja enodia do sondowania systemu OpenBSD przez SSH.
---

Należy do rodziny [identyfikacji systemów operacyjnych przez SSH](/pl/configuration/products/ssh-os-probes/),
ale nie do grupy os-release — OpenBSD w ogóle nie dostarcza odpowiednika
...
Zweryfikowano na żywo przez `vmactions/openbsd-vm` (poza tym nie istnieje
żaden gotowy, preinstalowany obraz do pobrania): `uname -sr` → `"OpenBSD 7.9"`,
