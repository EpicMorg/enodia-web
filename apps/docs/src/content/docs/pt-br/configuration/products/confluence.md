---
title: Confluence
description: Como configurar o enodia para sondar o Atlassian Confluence (Data Center).
---
...
O `<typeId>` do manifesto é comparado com o que `product: confluence`
...
consulte [Jira](/pt-br/configuration/products/jira/),
...
- `version`
- `extra.buildNumber`, `extra.typeId` — `typeId` conterá `confluence`
