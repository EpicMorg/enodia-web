---
title: EuroLinux
description: Como configurar o enodia para sondar o EuroLinux via SSH.
---
...
Não existe imagem Docker do EuroLinux — a verificação foi feita com uma
captura real do rootfs de uma ISO (a própria mídia de instalação,
examinada offline): `ID="eurolinux"`, `VERSION_ID="8.10"`.
