---
title: OpenBSD
description: Configurarea enodia pentru a sonda OpenBSD prin SSH.
---

Face parte din familia [Identificarea sistemului de operare prin SSH](/ro/configuration/products/ssh-os-probes/),
dar nu din grupul os-release — OpenBSD nu livrează deloc un echivalent
...
Verificat live prin `vmactions/openbsd-vm` (altfel nu există nicio imagine
preinstalată descărcabilă): `uname -sr` → `"OpenBSD 7.9"`, fără niciun nume de
