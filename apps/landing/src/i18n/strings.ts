...
> = {
	...
	uk: {
		description:
			'Знайте, що у вас запущено і скільки йому лишилося. Інвентаризація сервісів і моніторинг життєвого циклу/EOL для вашої інфраструктури.',
		tagline: 'Знайте, що у вас запущено і скільки йому лишилося.',
		pitch:
			'enodia опитує ваші сервіси щодо версії, звіряє її з календарями життєвого циклу вендорів і показує, що вже мертве, що вмирає і де версії у вашому парку розійшлися, а за вивантаженням БДУ ФСТЕК або NVD — ще й які відомі CVE зачіпають кожну конкретну версію. Один раз описали сервіси — далі enodia впорається сама.',
		or: 'або',
		docs: 'Документація',
		install: 'Встановлення',
		license: 'enodia розповсюджується за ліцензією {license}.',
	},
};
